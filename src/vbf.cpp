...
VariableCoutingBloomFilter::VariableCoutingBloomFilter(size_t m, uint8_t k, uint8_t L_set) : m{m}, k{k}, filter(m), f_set{murmurHash64A_Vector(k)}, g_set{murmurHash64A_Vector(k)}, L_set{L_set}{
